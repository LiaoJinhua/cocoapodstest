...
#ifndef _hci_tts_player_header_
#define _hci_tts_player_header_
...
typedef struct _PLAYER_CALLBACK_PARAM {
	Callback_PlayerEventStateChange pfnStateChange;
	void * pvStateChangeUsrParam;
	Callback_PlayerEventProgressChange pfnProgressChange;
	void * pvProgressChangeUsrParam;
	Callback_PlayerEventPlayerError pfnPlayerError;
	void * pvPlayerErrorUsrParam;
 ...
 * 使用本地能力合成音频时文本长度不要超过1024字节
 * @param	pszText				要播放的文本，UTF-8编码，以'\0'结束
 * @param	pszConfig			播放相关的配置串 详细说明 参见 hci_tts_session_start 需要添加合成的配置项
 * @return	
 * @n
 *	<table>
 *		<tr><td>@ref PLAYER_ERR_NONE</td><td>操作成功</td></tr>
