...
typedef enum {
	...
	//HCI_SYS 
	HCI_ERR_SYS_NOT_INIT = 100,				///< 100: HCI_SYS 未初始化
	...
	/* HCI_ASR */
	HCI_ERR_ASR_NOT_INIT = 200,				///< 200: HCI_ASR 没有初始化
	...
	HCI_ERR_ASR_ENGINE_NOT_INIT,			///< 205: 本地引擎尚未初始化
	HCI_ERR_ASR_ENGINE_INIT_FAILED,			///< 206: 本地引擎初始化失败
	HCI_ERR_ASR_OPEN_GRAMMAR_FILE,			///< 207: 读取语法文件失败
	HCI_ERR_ASR_LOAD_GRAMMAR_FAILED,		///< 208: 加载语法文件失败
	HCI_ERR_ASR_ENGINE_FAILED,				///< 209: 本地引擎识别失败
	...
	HCI_ERR_HWR_ENGINE_INIT_FAILED,			///< 303: 本地引擎初始化失败
	HCI_ERR_HWR_ENGINE_FAILED,				///< 304: 本地引擎操作（识别、获取拼音、获取联想结果）失败
	HCI_ERR_HWR_UPLOAD_NO_DATA,				///< 305: 无上传数据
	HCI_ERR_HWR_ENGINE_SESSION_START_FAILED,///< 306: 本地引擎开启会话失败
	...
	/* HCI_OCR */
	HCI_ERR_OCR_NOT_INIT = 400,				///< 400: HCI_OCR 没有初始化
	HCI_ERR_OCR_ALREADY_INIT,				///< 401: HCI_OCR 多次初始化
	HCI_ERR_OCR_ENGINE_INIT_FAILED,			///< 402: OCR本地引擎初始化失败
	HCI_ERR_OCR_ENGINE_FAILED,				///< 403: 本地引擎操作（倾斜校正、版面分析、识别、预处理、压缩）失败
	...
	/* HCI_TTS */
	HCI_ERR_TTS_NOT_INIT = 500,				///< 500: HCI_TTS 没有初始化
	HCI_ERR_TTS_ALREADY_INIT,				///< 501: HCI_TTS 多次初始化
	HCI_ERR_TTS_SESSION_BUSY,				///< 502: 会话正忙，例如在合成回调函数中又调用了合成
	HCI_ERR_TTS_ENGINE_SESSION_START_FAILED,///< 503: 本地引擎开启会话失败
	HCI_ERR_TTS_ENGINE_FAILED,				///< 504: 本地引擎合成失败

	/* HCI_NLU */
	HCI_ERR_NLU_NOT_INIT = 600,				///< 600: HCI_NLU 没有初始化
	HCI_ERR_NLU_ALREADY_INIT,				///< 601: HCI_NLU 多次初始化


	/*HCI_IMIND*/
	HCI_ERR_MIND_NOT_INIT = 700,			///< 700 :HCI_MIND 没有初始化
	HCI_ERR_MIND_ALREADY_INIT,				///< 701: HCI_MIND 多次初始化
	HCI_ERR_MIND_CONFIRM_NO_TASK,			///< 702: 使用confirm，但没有确认任务
	HCI_ERR_MIND_SOLUTION_MISS,				///< 703: 在使用中没有给定解决方案名称
} HCI_ERR_CODE;
 ...
 *		<tr><td>@ref HCI_ERR_SYS_CONFIG_PLATFORMID_MISSING</td><td>缺少必需的platformId配置项</td></tr>
 *		<tr><td>@ref HCI_ERR_SYS_CONFIG_DEVELOPERID_MISSING</td><td>缺少必需的developerId配置项</td></tr>
 *		<tr><td>@ref HCI_ERR_SYS_CONFIG_DEVELOPERKEY_MISSING</td><td>缺少必需的developerKey配置项</td></tr>
 *		<tr><td>@ref HCI_ERR_SYS_CONFIG_APPNO_MISSING</td><td>缺少必需的appNo配置项</td></tr>
 *	</table>
 *
 * @par 配置串定义：
 ...
 *		<tr>
 *			<td>userId</td>
 *			<td>app_1809988776655</td>
 *			<td>无</td>
 *			<td>用户标识</td>
 *			<td>2.3版本已废弃，可以不设置此项。如果授权文件从灵云管理后台获取的，此项不填，否则不能使用灵云sdk</td>
 *		</tr>
 *		<tr>
 *			<td>password</td>
 *			<td>pw2012</td>
 ...
 * platformId=1,developerId=1002,developerKey=abcdefgh,appNo=1,
 ...
 * <b>应用信息</b>
 * @n@n
 * 配置项中platformId, developerId, developerKey, appNo四项内容由捷通华声提供，用于标识不同的开发者
